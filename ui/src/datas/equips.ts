import { AACITriggerEquipType, EquipDatas, EquipType, SkillTriggerEquipType, SpecialIcon } from "@/types/equip";
...
const EQUIPDATA: EquipDatas = {
  ...
  102: {
    ...
    nameJP: '九八式水上偵察機(夜偵)',
    type: EquipType.SEAPLANE, icon: SpecialIcon.NightScout,
    is_night_scout: true,
    ASW: 1,
    LOS: 3,
    ACC: 1
  ...
  445: {
    ...
    nameJP: '二式複戦 屠龍',
    type: EquipType.INTERCEPTOR, icon: SpecialIcon.ArmyLandBasedFighters,
    AA: 3,
    AR: 1,
    AB: 4,
    IN: 1,
  ...
  473: {
    ...
    type: EquipType.FIGHTER, icon: SpecialIcon.NightFighters,
    b_type: SkillTriggerEquipType.B_NIGHTFIGHTER,
    FP: 1,
    AA: 9,
    ACC: 1,
  ...
  516: {
    ...
    type: EquipType.INTERCEPTOR, icon: SpecialIcon.JetLandBasedFighters,
    DIVEBOMB: 3,
    AA: 15,
    AB: 6,
    IN: 1,
  ...
  546: {
    ...
    nameJP: '試製 震電(局地戦闘機)',
    type: EquipType.INTERCEPTOR, icon: SpecialIcon.PropulsionLandBasedFighters,
    AA: 14,
    AB: 5,
    IN: 4,
  },
