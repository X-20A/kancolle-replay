 ...
 */
export function can_OASW_by_ship_type(ship: PlayerShip): boolean {
 ...
 * @returns 
 */
function is_DE_capable_of_OASW(ship: PlayerShip): boolean {
 ...
 * 軽空母が先制対潜可能か判定して返す
 */
function is_CVL_capable_of_OASW(ship: PlayerShip): boolean {
 ...
 * @returns 閾値以上かどうか
 */
function has_view_ASW_at_least(ship: PlayerShip, threshold: number): boolean {
 ...
 */
function has_sonar_and_view_ASW_at_least(ship: PlayerShip, threshold: number): boolean {
