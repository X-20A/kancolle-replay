// classで宣言されてないが役割はインスタンスだと思うのでコメントではインスタンスとして扱う
// ただしあくまでオブジェクトなので動的に追加されるプロパティがそこそこある
 ...
 * @property {Array<number>} equips - 装備IDの配列
 ...
 * @property {boolean | Fleet} fleet - 艦隊インスタンス
 ...
 * @property {number} _aswpower - 対潜攻撃力
